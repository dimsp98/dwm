...
static const Key keys[] = {
    ...
    { 0,                            XK_Print,  spawn,          SHCMD(" maim ~/Pictures/Screenshots/$(date +%Y-%m-%d-%H-%M-%S).png && notify-send 'Screenshot saved'") },
    {MODKEY,                        XK_Print,  spawn,          SHCMD(" maim -s ~/Pictures/Screenshots/$(date +%Y-%m-%d-%H-%M-%S).png && notify-send 'Screenshot saved'") },
    {MODKEY|ShiftMask,              XK_Print,  spawn,          SHCMD(" maim --delay 3 ~/Pictures/Screenshots/$(date +%Y-%m-%d-%H-%M-%S).png && notify-send 'Screenshot saved'") },
